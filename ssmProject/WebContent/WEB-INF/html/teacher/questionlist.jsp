...
<html>
	...
	<body>
		<header class="headerBar">
			<a href="teacherindex.jsp" class="welcome_tit fl">西工答疑 · 成就梦想</a>
		...
		<div class="listTit comWidth">
			<ul class="question_list">
				<li class="question_item">
					<a href="" class="question_title">求解Java对象与类</a>
					<ul>
						<li class="answer_item">
							<span class="answer_title"><i class="answer_user">130611106</i>&nbsp;&nbsp;&nbsp;提问：</span>
							...
							<span class="answer_time">
								...
								<form action="" method="post" class="fr" id="reportForm">
									<button type="submit" value="" class="operate_btn">回复</button>
								</form>
							</span>
						</li>
